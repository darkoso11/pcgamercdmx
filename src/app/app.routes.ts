...
export const routes: Routes = [
  ...
  { path: 'productos/:slug', loadComponent: () => import('./features/products/product-detail.component').then(m => m.ProductDetailComponent), data: { renderMode: 'server' } },
  ...
  { path: 'blog/:slug', loadComponent: () => import('./features/blog/blog-detail.component').then(m => m.BlogDetailComponent), data: { renderMode: 'server' } },
