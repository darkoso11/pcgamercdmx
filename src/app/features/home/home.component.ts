...
export class HomeComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  sliderImages = [
    { id: 1, src: 'https://picsum.photos/id/11/200/100', link: '/productos/1', alt: 'Slider 1' },
    { id: 2, src: 'https://picsum.photos/id/12/200/100', link: '/productos/2', alt: 'Slider 2' },
    { id: 3, src: 'https://picsum.photos/id/13/200/100', link: '/productos/3', alt: 'Slider 3' }
  ];
  sliderIndex = 0;
